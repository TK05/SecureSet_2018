...
#restrict target input to set time difficulty
#
###############################
...
#restrict target difficulty
def diff_check (target):

	#assuming 6,000,000 hash/sec
	#10300*(2**32)/(6*10**6)/60/60/24 = ~85 days
	target_difficulty = 10300
	current_difficulty = ((2**224)/target)
